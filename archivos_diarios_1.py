...
def modificar_archivo(diario):
    ...
    # cada elemento es el nombre del archivo .txt con los titulares de cada diario encontrados en la carpeta 'proy_copia_2'.
...
archivos_diarios = os.listdir('C:/Users/inesd/Documents/Wrangling_R/proyecto_copia_2')# lista de archivos en la carpeta 'proyecto_copia_2'
...
for i in range(len(archivos_diarios)):
    ...
    modificar_archivo(diario_prueba)# le aplico la función al archivo .txt que realizará modificaciones y guardará esa nueva versión
# como csv
############################
